...
{ // Starting point of the program, where execution begins
   ...
   for(int i=0; i<5; i++) 
   { // Starting a loop that iterates from i=0 to i<5 with i incrementing by 1 each iteration
   ...
   for(int i=0; i<5; i++) 
   { // Starting another loop that iterates from i=0 to i<5 with i incrementing by 1 each iteration
